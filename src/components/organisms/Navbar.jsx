          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            >
              {theme === "dark" ? (
                <Sun
                  size={17}
                  className="text-solar-400 group-hover:rotate-45 transition-transform duration-300"
                />
              ) : (
                <Moon
                  size={17}
                  className="text-sky-500 group-hover:-rotate-12 transition-transform duration-300"
                />
              )}
            </button>
